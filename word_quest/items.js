...
const ITEMS = [
  ...
  { id: 'runeblade',             name: 'Runeblade',             slot: 'sword',  imagePath: 'items/sword/runeblade.png',            dur: 12, att: 12, def: 0,  value: 55,  rarity: 4, droprate: 3  },
  { id: 'celestial_greatsword',  name: 'Celestial Greatsword',  slot: 'sword',  imagePath: 'items/sword/celestial_greatsword.png', dur: 15, att: 15, def: 0,  value: 120, rarity: 5, droprate: 0.1, indestructible: 1 },
  ...
  { id: 'celestial_crown',       name: 'Celestial Crown',       slot: 'helmet', imagePath: 'items/helmet/celestial_crown.png', dur: 15, att: 0,  def: 16, value: 120, rarity: 5, droprate: 0.1, indestructible: 1 },
  ...
  { id: 'celestial_armor',       name: 'Celestial Armor',       slot: 'torso',  imagePath: 'items/torso/celestial_armor.png',   dur: 15, att: 0,  def: 22, value: 120, rarity: 5, droprate: 0.1, indestructible: 1 },
  ...
  { id: 'celestial_gauntlets',   name: 'Celestial Gauntlets',   slot: 'gloves', imagePath: 'items/gloves/celestial_gauntlets.png', dur: 15, att: 5,  def: 11, value: 120, rarity: 5, droprate: 0.1, indestructible: 1 },
  ...
  { id: 'celestial_greaves',     name: 'Celestial Greaves',     slot: 'foot',   imagePath: 'items/foot/celestial_greaves.png',   dur: 15, att: 0,  def: 12, value: 120, rarity: 5, droprate: 0.1, indestructible: 1 },
];
