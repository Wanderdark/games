...
const ITEMS = [
  ...
  { id: 'runeblade',             name: 'Runeblade',             slot: 'sword',  imagePath: 'items/sword/runeblade.png',            dur: 12, att: 12, def: 0,  value: 55,  rarity: 4, droprate: 8  },
  { id: 'celestial_greatsword',  name: 'Celestial Greatsword',  slot: 'sword',  imagePath: 'items/sword/celestial_greatsword.png', dur: 15, att: 15, def: 0,  value: 120, rarity: 5, droprate: 2  },
  ...
  { id: 'runed_helmet',          name: 'Runed Helmet',          slot: 'helmet', imagePath: 'items/helmet/runed_helmet.png',    dur: 12, att: 0,  def: 11, value: 55,  rarity: 4, droprate: 8  },
  { id: 'celestial_crown',       name: 'Celestial Crown',       slot: 'helmet', imagePath: 'items/helmet/celestial_crown.png', dur: 15, att: 0,  def: 16, value: 120, rarity: 5, droprate: 2  },
  ...
  { id: 'runed_breastplate',     name: 'Runed Breastplate',     slot: 'torso',  imagePath: 'items/torso/runed_breastplate.png', dur: 12, att: 0,  def: 15, value: 55,  rarity: 4, droprate: 8  },
  { id: 'celestial_armor',       name: 'Celestial Armor',       slot: 'torso',  imagePath: 'items/torso/celestial_armor.png',   dur: 15, att: 0,  def: 22, value: 120, rarity: 5, droprate: 2  },

  // GLOVES
  { id: 'leather_gloves',        name: 'Leather Gloves',        slot: 'gloves', imagePath: 'items/gloves/leather_gloves.png',      dur: 3,  att: 1,  def: 1,  value: 5,   rarity: 1, droprate: 50 },
  { id: 'iron_gauntlets',        name: 'Iron Gauntlets',        slot: 'gloves', imagePath: 'items/gloves/iron_gauntlets.png',      dur: 5,  att: 2,  def: 2,  value: 12,  rarity: 2, droprate: 25 },
  { id: 'knights_gauntlets',     name: "Knight's Gauntlets",    slot: 'gloves', imagePath: 'items/gloves/knights_gauntlets.png',   dur: 8, att: 3,  def: 4,  value: 25,  rarity: 3, droprate: 15 },
  { id: 'runed_gauntlets',       name: 'Runed Gauntlets',       slot: 'gloves', imagePath: 'items/gloves/runed_gauntlets.png',     dur: 12, att: 5,  def: 6,  value: 55,  rarity: 4, droprate: 8  },
  { id: 'celestial_gauntlets',   name: 'Celestial Gauntlets',   slot: 'gloves', imagePath: 'items/gloves/celestial_gauntlets.png', dur: 15, att: 8,  def: 9,  value: 120, rarity: 5, droprate: 2  },
  ...
  { id: 'runed_greaves',         name: 'Runed Greaves',         slot: 'foot',   imagePath: 'items/foot/runed_greaves.png',       dur: 12, att: 0,  def: 8,  value: 55,  rarity: 4, droprate: 8  },
  { id: 'celestial_greaves',     name: 'Celestial Greaves',     slot: 'foot',   imagePath: 'items/foot/celestial_greaves.png',   dur: 15, att: 0,  def: 12, value: 120, rarity: 5, droprate: 2  },
];
